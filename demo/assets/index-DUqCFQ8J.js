...
function Uc(e, t, n, r, l, u, o, i, s) {
  (xn = !1), (Rr = null), Mc.apply(Fc, arguments);
}
...
function bc(e, t, n, r, l) {
  switch (t) {
    ...
    case "gotpointercapture":
      return (
        (u = l.pointerId), Dn.set(u, dn(Dn.get(u) || null, e, t, n, r, l)), !0
      );
  }
  return !1;
}
...
function Mn(e) {
  ...
  for (; 0 < qe.length && ((n = qe[0]), n.blockedOn === null); )
    js(n), n.blockedOn === null && qe.shift();
}
...
function qu(e, t, n, r) {
  if (Dr) {
    var l = cu(e, t, n, r);
    if (l === null) Il(e, t, r, Mr, n), Yo(e, r);
...
var Mr = null;
function cu(e, t, n, r) {
  if (((Mr = null), (e = Xu(r)), (e = St(e)), e !== null))
...
var Nf = We && "TextEvent" in window && !Cn,
...
function Lf(e, t) {
  if (Dt)
    return e === "compositionend" || (!no && Ms(e, t))
      ? ((e = Is()), (kr = bu = tt = null), (Dt = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function As(e) {
  if (e.propertyName === "value" && rl(Fn)) {
    var t = [];
    Us(t, Fn, e, Xu(e)), ws(Rf, t);
  }
}
function Of(e, t, n) {
  e === "focusin"
    ? (ri(), (_n = t), (Fn = n), _n.attachEvent("onpropertychange", As))
    : e === "focusout" && ri();
}
function If(e) {
...
function ht() {
  if (!Ml && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), xs(Gu, ht), l);
    } finally {
      (O = t), (Ml = !1);
    }
  }
...
function zi(e, t, n, r, l) {
  if (e === null) {
    ...
    return typeof u == "function" &&
      ...
      ? ((t.tag = 15), (t.type = u), La(e, t, u, r, l))
...
function Li(e, t, n, r, l) {
  ...
  if ((Gt(t, l), t.stateNode === null))
    Pr(e, t), Pa(t, n, r), xu(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      i = t.memoizedProps;
    o.props = i;
...
function ad(e, t, n) {
  ...
  switch ((uo(t), t.tag)) {
    ...
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = Et(Ue.current)), dr(t))) {
          ...
          switch (((r[Me] = t), (r[Vn] = u), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
    ...
    case 17:
      return de(t.type) && $r(), ne(t), null;
    case 19:
      if ((M($), (u = t.memoizedState), u === null)) return ne(t), null;
...
function dd(e, t) {
  ...
  for (mu = { focusedElem: e, selectionRange: n }, Dr = !1, k = t; k !== null; )
...
function Ua(e) {
  ...
  t !== null && ((e.alternate = null), Ua(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Me], delete t[Vn], delete t[yu], delete t[Xf], delete t[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ha(e, t) {
  ...
  if (t !== 0) {
    if (
      (t === 2 && ((l = su(e)), l !== 0 && ((r = l), (t = Mu(e, l)))), t === 1)
    )
...
const Rd = ({ baseUrl: e }) => ({
    listSlugs: async () => ["about", "contact", "blog-post-1", "blog-post-2"],
    load: async (t) => ({
      slug: t,
      title: `Content for ${t}`,
      content: `This is the content for ${t}`,
      created: new Date().toISOString(),
    }),
  }),
  jd = ({ projectId: e, setProjectId: t, apiSecret: n, setApiSecret: r }) =>
    j.jsxs("div", {
...
function Dd() {
  ...
  return j.jsxs("div", {
    ...
    children: [
      ...
      j.jsx(Od, { handleRun: s, disabled: o }),
      j.jsx(Id, { result: l, loading: o }),
    ],
  });
}
Ql.createRoot(document.getElementById("root")).render(
  j.jsx(gc.StrictMode, { children: j.jsx(Dd, {}) })
);
