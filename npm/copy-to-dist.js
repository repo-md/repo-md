...
if (!fs.existsSync(distDir)) {
  console.error('Dist directory does not exist. Make sure to run the build first.');
  process.exit(1);
}
...
if (fs.existsSync(cliNpmDir)) {
  ...
  console.warn('CLI source directory not found. CLI files will not be included.');
}
